...
const Home = () => (
  <div className="w-full p-6 mx-auto bg-white">
    <p className="text-center opacity-50 w-full mt-10 font-semibold text-lg mb-4">
    ...
    <VictoryChart
      width={1200}
      height={400}
      padding={{ right: 40, left: 40, top: 0, bottom: 30 }}
      theme={VictoryTheme.material}
      containerComponent={<VictoryZoomContainer responsive={true} />}
      minDomain={{ x:18, y:36 }}
      maxDomain={{ x:51, y:2480 }}
    >
      <VictoryAxis
        dependentAxis
        style={{
          tickLabels: { fontSize: '10px', padding: 10 },
        }}
      />
      <VictoryAxis
        tickFormat={(t) => 'Week '+t }
